# Comparing `tmp/nsface_python-1.1.61-py3-none-any.whl.zip` & `tmp/nsface_python-1.1.63-py3-none-any.whl.zip`
...
+Zip file size: 203073 bytes, number of entries: 94
...
+-rw-r--r--  2.0 unx    14138 b- defN 23-May-03 06:11 nsface/face/get_result.py
...
+-rw-r--r--  2.0 unx     2496 b- defN 23-May-03 06:20 nsface/model_zoo/model_attribute/arcface_GenderAge.py
+-rw-r--r--  2.0 unx     2185 b- defN 23-May-03 06:20 nsface/model_zoo/model_attribute/arcface_Race.py
...
+-rw-r--r--  2.0 unx     3476 b- defN 23-May-03 06:20 nsface/model_zoo/model_detection/liveness.py
...
+-rw-r--r--  2.0 unx     6866 b- defN 23-May-03 06:19 nsface/utils/util_common.py
...
+-rw-r--r--  2.0 unx      531 b- defN 23-May-03 06:21 nsface_python-1.1.63.dist-info/METADATA
+-rw-r--r--  2.0 unx       92 b- defN 23-May-03 06:21 nsface_python-1.1.63.dist-info/WHEEL
+-rw-r--r--  2.0 unx       61 b- defN 23-May-03 06:21 nsface_python-1.1.63.dist-info/entry_points.txt
+-rw-r--r--  2.0 unx        7 b- defN 23-May-03 06:21 nsface_python-1.1.63.dist-info/top_level.txt
+?rw-rw-r--  2.0 unx     8913 b- defN 23-May-03 06:21 nsface_python-1.1.63.dist-info/RECORD
+94 files, 655788 bytes uncompressed, 188609 bytes compressed:  71.2%
```
...
+Filename: nsface_python-1.1.63.dist-info/METADATA
 Comment: 
 
-Filename: nsface_python-1.1.61.dist-info/WHEEL
+Filename: nsface_python-1.1.63.dist-info/WHEEL
 Comment: 
 
-Filename: nsface_python-1.1.61.dist-info/entry_points.txt
+Filename: nsface_python-1.1.63.dist-info/entry_points.txt
 Comment: 
 
-Filename: nsface_python-1.1.61.dist-info/top_level.txt
+Filename: nsface_python-1.1.63.dist-info/top_level.txt
 Comment: 
 
-Filename: nsface_python-1.1.61.dist-info/RECORD
+Filename: nsface_python-1.1.63.dist-info/RECORD
 Comment: 
...
+def get_ageGender(model_name,model,img,faces,to_bgr=False,mask_off=False):
         
     if model_name=='arcface_cmt':
         for face in faces:
-            model.get(img,face,to_bgr)
+            model.get(img,face,to_bgr,mask_off=mask_off)
             
     return faces
 
-def get_Race(model_name,model,img,faces,to_bgr=False):
+def get_Race(model_name,model,img,faces,to_bgr=False,mask_off=False):
...
+def get_liveness(model,faces,img,mask_off=False,**kwargs):
     for face in faces:
-        model.liveness_check(img,face)
+        model.liveness_check(img,face,mask_off=mask_off)
...
+    def get(self,img,face,to_bgr,mask_off=False):
...
+    def liveness_check(self,img,face,mask_off=False): # RGB input original image, (x1,y1,x2,y2) bbox_ori
+
+        if mask_off and np.argmax(face['mask_sf'])==1:
+            face.liveness_sf=[]
+            return []
...
## Comparing `nsface_python-1.1.61.dist-info/METADATA` & `nsface_python-1.1.63.dist-info/METADATA`
...
## Comparing `nsface_python-1.1.61.dist-info/RECORD` & `nsface_python-1.1.63.dist-info/RECORD`
...
+nsface/face/get_result.py,sha256=SCMkYa7q9CLb7Ii4lzFFUOEdFfVBLbl_ZsPtOM6JKgc,14138
...
+nsface/model_zoo/model_attribute/arcface_GenderAge.py,sha256=ZDY7nn1qRhUtQSNYJTwXVRcdMCUc1pccERWTwe3Q670,2496
+nsface/model_zoo/model_attribute/arcface_Race.py,sha256=ENOIsNQbPEBDglCFCD4HvXb-IbBYdJuTXdaXgkf9u6A,2185
...
+nsface/model_zoo/model_detection/liveness.py,sha256=WgtwiQH6PP9gRgetC8yPbExGa8fsoSs2aHhF3RbGusE,3476
...
+nsface/utils/util_common.py,sha256=k7Kj2W4M-4HN8Xw6RZ6kwvgyWfIvhHyS8KcBZyc8VkI,6866
...
+nsface_python-1.1.63.dist-info/METADATA,sha256=4beY5QvLHJhY-C5tU-9mEX5v40Dzk9f1fH4eCB54LCo,531
+nsface_python-1.1.63.dist-info/WHEEL,sha256=G16H4A3IeoQmnOrYV4ueZGKSjhipXx8zc8nu9FGlvMA,92
+nsface_python-1.1.63.dist-info/entry_points.txt,sha256=DbtzII_7RVEDraozv5k76t6JDOjZZm-ruRZs4N3nF6s,61
+nsface_python-1.1.63.dist-info/top_level.txt,sha256=Mn7kn43NX5shzD8I7wvIzyeGYMEJ9z08sfyIPRzHVfQ,7
+nsface_python-1.1.63.dist-info/RECORD,,
```
