# Comparing `tmp/prepup-0.0.12.tar.gz` & `tmp/prepup-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "prepup-0.0.12.tar", last modified: Tue May  2 23:26:11 2023, max compression
+gzip compressed data, was "prepup-0.0.9.tar", last modified: Mon May  1 01:53:26 2023, max compression
```

## Comparing `prepup-0.0.12.tar` & `prepup-0.0.9.tar`

### file list

```diff
@@ -1,19 +1,22 @@
-drwxrwxrwx   0        0        0        0 2023-05-02 23:26:11.426175 prepup-0.0.12/
--rw-rw-rw-   0        0        0      188 2023-04-29 20:41:27.000000 prepup-0.0.12/AUTHORS.rst
--rw-rw-rw-   0        0        0     1100 2023-04-29 20:41:27.000000 prepup-0.0.12/LICENSE
--rw-rw-rw-   0        0        0      129 2023-04-29 20:41:27.000000 prepup-0.0.12/MANIFEST.in
--rw-rw-rw-   0        0        0      494 2023-05-02 23:26:11.422162 prepup-0.0.12/PKG-INFO
--rw-rw-rw-   0        0        0      489 2023-04-29 20:41:27.000000 prepup-0.0.12/README.md
-drwxrwxrwx   0        0        0        0 2023-05-02 23:26:11.400250 prepup-0.0.12/prepup/
--rw-rw-rw-   0        0        0    12101 2023-05-02 23:25:44.000000 prepup-0.0.12/prepup/__init__.py
--rw-rw-rw-   0        0        0    28973 2023-05-02 23:22:18.000000 prepup-0.0.12/prepup/common.py
-drwxrwxrwx   0        0        0        0 2023-05-02 23:26:11.420161 prepup-0.0.12/prepup.egg-info/
--rw-rw-rw-   0        0        0      494 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      285 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       48 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0      220 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/requires.txt
--rw-rw-rw-   0        0        0        7 2023-05-02 23:26:11.000000 prepup-0.0.12/prepup.egg-info/top_level.txt
--rw-rw-rw-   0        0        0      367 2023-04-29 23:00:31.000000 prepup-0.0.12/requirements.txt
--rw-rw-rw-   0        0        0       42 2023-05-02 23:26:11.426175 prepup-0.0.12/setup.cfg
--rw-rw-rw-   0        0        0     3185 2023-05-02 23:26:07.000000 prepup-0.0.12/setup.py
...
### Comparing `prepup-0.0.12/LICENSE` & `prepup-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `prepup-0.0.12/prepup/common.py` & `prepup-0.0.9/prepup/common.py`
...
### Comparing `prepup-0.0.12/setup.py` & `prepup-0.0.9/setup.py`
