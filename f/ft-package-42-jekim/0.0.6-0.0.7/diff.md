# Comparing `tmp/ft_package_42_jekim-0.0.6.tar.gz` & `tmp/ft_package_42_jekim-0.0.7.tar.gz`
...
## Comparing `ft_package_42_jekim-0.0.6.tar` & `ft_package_42_jekim-0.0.7.tar`
...
### Comparing `ft_package_42_jekim-0.0.6/setup.py` & `ft_package_42_jekim-0.0.7/setup.py`
